        ...
        <div class="container">
          <div class="row bar">
            <div id="customer-account" class="col-lg-9 clearfix">
              <p class="lead">Ubah informasi sandi dan data akun anda</p>
              <div class="box mt-5">
                <div class="heading">
                  <h3 class="text-uppercase">Ubah Sandi</h3>
                </div>
                <form>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="password_old">Sandi lama</label>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="password_1">Sandi baru</label>
                        <input id="password_1" type="password" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="password_2">Ketik ulang sandi baru</label>
                        <input id="password_2" type="password" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div class="text-center">
                    <button type="submit" class="btn btn-template-outlined"><i class="fa fa-save"></i> Simpan sandi baru</button>
                  </div>
                </form>
              </div>
              <div class="bo3">
                <div class="heading">
                  <h3 class="text-uppercase">Info akun</h3>
                </div>
                <form>
                  <div class="row">
                    <div class="col-md-6">
              ...
              <!-- CUSTOMER MENU -->
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="<?php echo base_url('admin/overview');?>" class="nav-link active"><i class="fa fa-list"></i> Pesanan Saya</a></li>
