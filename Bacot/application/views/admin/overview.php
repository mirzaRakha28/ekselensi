                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3">
                          ...
                          <ul class="list-unstyled mb-3">
                            ...
                            <li class="nav-item"><a href="<?php echo base_url('admin/customer_account');?>" class="nav-link">Customer account / change password</a></li>
                          </ul>
                        </div>
                        <div class="col-md-6 col-lg-3">
                          <h5>Shop</h5>
                          <ul class="list-unstyled mb-3">
                            <li class="nav-item"><a href="<?php base_url('admin/overview');?>" class="nav-link">Category - sidebar right</a></li>
