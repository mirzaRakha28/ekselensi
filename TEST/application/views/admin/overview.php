...
<html>
  <head>
    ...
    <!-- Bootstrap Select-->
    <link href="<?php echo base_url('vendor/bootstrap-select/css/bootstrap-select.min.css') ?>" rel="stylesheet">
    <!-- owl carousel-->
    <link href="<?php echo base_url('vendor/owl.carousel/assets/owl.carousel.css') ?>" rel="stylesheet">
    <link href="<?php echo base_url('vendor/owl.carousel/assets/owl.theme.default.css') ?>" rel="stylesheet">
    <!-- theme stylesheet-->
    <link href="<?php echo base_url('css/style.default.css" id="theme-stylesheet') ?>" rel="stylesheet">
