            ...
            <tbody>
                <tr>
                    <td style="width: 348px;max-width: 348px;min-width: 348px;min-height: 515px;max-height: 515px;">
                        <a href="<?= base_url('product/sub_product') ?>"><div class="card" style="height: 279px;max-height: 279px;max-width: 324px;min-height: 279px;min-width: 324px;"><img class="card-img-top w-100 d-block" src="<?= base_url()?>assets/img/desk.jpg">
                            <div class="card-body">
                    ...
                    <td style="width: 348px;max-width: 348px;min-width: 348px;min-height: 515px;max-height: 515px;">
                    <a href="<?= base_url('product/sub_product') ?>"><div class="card" style="height: 279px;max-height: 490px;max-width: 324px;">
                    ...
                    <td style="width: 348px;max-width: 348px;min-width: 348px;min-height: 515px;max-height: 515px;">
                        <a href="<?= base_url('product/sub_product') ?>">
