    <div class="page-content-wrapper">
                ...
                <form style="margin-right: 0px;margin-left: 46px;"><label>Judul Kategori</label>
                    <div class="dropdown"><button class="btn btn-primary btn-lg dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button" style="width: 185px;">Outdoor</button>
